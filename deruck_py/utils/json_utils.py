...
@overload
def load_json_string(s: str, type_: Type[LoadType]) -> LoadType: ...
...
def dump_json_list(obj: List[Any], file: Union[str, Path], exclude_none: bool = False) -> None:
